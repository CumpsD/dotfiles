        ...
        Rectangle {
            ...
            Rectangle {
                ...
                Text {
                    ...
                    visible: config.showUserNameLabel != "false"
                }
                ...
                TextBox {
                    ...
                    anchors.verticalCenter: parent.verticalCenter
                    anchors.left: config.showUserNameLabel != "false" ? username_label.right : parent.left
            ...
            Rectangle {
                ...
                PasswordBox {
                    ...
                    height: parent.height
                    font.family: textFont.name
                    font.pixelSize: config.passwordFontSize
                    color: "#25000000"
                    anchors.verticalCenter: parent.verticalCenter
                    anchors.right: parent.right
                    anchors.rightMargin: parent.height // this sets button width, this way its a square
                    anchors.left: config.showPasswordLabel != "false" ? password_label.right : parent.left
